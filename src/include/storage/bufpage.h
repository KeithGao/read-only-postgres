...
typedef struct NewPageHeaderData
{
 ...
 */
#define PageIsNew(page) (((NewPageHeader) (page))->pd_upper == 0)
 ...
 */
#define PageGetSpecialSize(page) ((uint16) 0)
...
extern bool PageHeaderIsValid(NewPageHeader page);
